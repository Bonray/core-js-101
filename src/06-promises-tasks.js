...
function willYouMarryMe(isPositiveAnswer) {
  let promise;
  if (typeof isPositiveAnswer !== 'boolean') promise = new Promise((resolve, reject) => reject(new Error('Wrong parameter is passed! Ask her again.')));
  else if (isPositiveAnswer) promise = new Promise((resolve) => resolve('Hooray!!! She said "Yes"!'));
  else if (!isPositiveAnswer) promise = new Promise((resolve) => resolve('Oh no, she said "No".'));
  return promise;
}
